...
1. 业务和采购进入“客户供应商”，维护客户、供应商、联系人、账期和负责人。
2. 采购进入“供应商导入”，贴入或选择供应商 CSV。
3. 工程/采购进入“清洗审核”，确认映射或新建物料。
4. 工程维护“产品工程”和“BOM 管理”。
5. 采购在“采购与库存”生成缺料建议、采购单并收货入库。
6. 仓库在“采购与库存”的“库存盘点调整”录入实盘数量，系统保留调整记录。
7. 生产在“生产协同”生成工单、领料、完工入库。
8. 品质在“品质管理”记录 IQC、IPQC、FQC。
9. 销售在“询价报价”创建报价单，客户确认后转成销售订单。
10. 销售在“销售交付”跟进订单并按成品库存出货。
11. 财务在“财务结算”生成应收、应付，并登记收款、付款。
12. 管理层在“系统运维”查看风险、指标、操作记录和备份。
