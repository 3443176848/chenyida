...
5. 仓库在“采购与库存”的“库存盘点调整”录入实盘数量，系统保留调整记录。
6. 生产在“生产协同”生成工单、领料、完工入库。
7. 品质在“品质管理”记录 IQC、IPQC、FQC。
8. 销售在“销售交付”创建订单并按成品库存出货。
9. 财务在“财务结算”生成应收、应付，并登记收款、付款。
10. 管理层在“系统运维”查看风险、指标、操作记录和备份。
