...
test("manifest is complete, safe, and binds exactly 0001-0016", async () => {
  ...
  assert.equal(manifest.target_migrations.length, 16); assert.equal(validateManifest(manifest), manifest);
