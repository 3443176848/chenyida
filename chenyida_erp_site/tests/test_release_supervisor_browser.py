...
EXPECTED_POLICY_SHA256 = "611202d33c6923f6d8f41cd85abef2c96df3fdd7ebb41bfd1aed7e62b8b4ea72"
...
EXPECTED_PACKAGE_LOCK_SHA256 = "9c3949bfdce05d355287550bdc7981a0e4cc455e99ae1735e39ee0b4c9252eb5"
EXPECTED_NODE_MODULES_TREE_SHA256 = "2b8223f9c604300ac18f2996cb93e404b2c27897945c143626a3cfedee4209fd"
...
class ReleaseSupervisorBrowserTest(unittest.TestCase):
    def test_browser_runtime_policy_is_exact_and_content_addressed(self):
        ...
        self.assertEqual(policy["node_dependencies"]["package_lock_sha256"], EXPECTED_PACKAGE_LOCK_SHA256)
        self.assertEqual(policy["node_dependencies"]["tree_sha256"], EXPECTED_NODE_MODULES_TREE_SHA256)
        package_lock = (SITE_ROOT / "package-lock.json").read_bytes()
        self.assertEqual(hashlib.sha256(package_lock).hexdigest(), EXPECTED_PACKAGE_LOCK_SHA256)
    ...
    def test_browser_shell_is_offline_serial_bounded_and_owned(self):
        ...
        self.assertIn(f"PACKAGE_LOCK_SHA256='{EXPECTED_PACKAGE_LOCK_SHA256}'", source)
        self.assertIn(f"NODE_MODULES_TREE_SHA256='{EXPECTED_NODE_MODULES_TREE_SHA256}'", source)
