...
const service = new DashboardService(new PostgresDashboardRepository(pool), statusFile);
...
test("trusted verification file is independent from PostgreSQL business facts", async () => {
  ...
  await writeFile(statusFile, JSON.stringify({
    ...
    verified_at: "2026-07-25T02:00:00Z",
    application_version: "0.1.0-alpha.10",
    git_commit: "b".repeat(40),
    migration_head: "0013_finance.sql",
    artifacts: {
