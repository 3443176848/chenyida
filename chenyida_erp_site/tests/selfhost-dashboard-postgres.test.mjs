...
await writeFile(releaseFile, JSON.stringify({ schema_version: 3, contract: "chenyida-erp-runtime-release-identity/v3", deployment_class: "TEST", deployment_id: "dashboard-test", release_id: "dashboard-release", release_manifest_sha256: process.env.ERP_RELEASE_EXPECTED_MANIFEST_SHA256, postdeploy_receipt_sha256: "9".repeat(64), supervisor_bundle_sha256: process.env.ERP_RELEASE_EXPECTED_SUPERVISOR_BUNDLE_SHA256, authorization_sha256: "f".repeat(64), runtime_guard: { contract: "chenyida-erp-release-runtime-guard/v1", mode: "POST_DEPLOY_CURRENT_RUNTIME_STRICT" }, runtime_policy_sha256: "e4920820ed954c2689e3de53dea9b7f36945969c8287b06d87a3871e7d3ecf00", application_version: "0.1.0-alpha.47", git_commit: "b".repeat(40), git_tree: "c".repeat(40), migration_head: runtimeMigrationHead, migration_manifest_sha256: runtimeMigrationManifestSha, caddy_container_id: "1".repeat(64), caddy_image_digest: `sha256:${"1".repeat(64)}`, postgres_container_id: "2".repeat(64), postgres_image_digest: `sha256:${"2".repeat(64)}`, web_container_id: runtimeHostname.padEnd(64, "a"), web_image_digest: `sha256:${"b".repeat(64)}`, worker_container_id: "c".repeat(64), worker_image_digest: `sha256:${"c".repeat(64)}`, generated_at: new Date().toISOString() }), { mode: 0o440 });
