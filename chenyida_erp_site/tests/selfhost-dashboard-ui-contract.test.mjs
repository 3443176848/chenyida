...
test("legacy backup governance renders missing or invalid evidence without inventing readiness", () => {
  ...
  for (const field of ["evidence_scope", "transfer_status", "encryption_status", "cluster_transfer_status", "cluster_security_status", "credential_binding_status", "tablespace_status", "recovery_execution_status", "schedule_status", "retention_status"]) {
  ...
  assert.match(legacy, /<td colspan="18">没有可信验证记录<\/td>/);
