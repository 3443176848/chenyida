...
test("legacy supplier import delegates to the native PostgreSQL batch workflow", () => {
  ...
  assert.match(html, /app\.js\?v=20260730-review-logout-cache-03/);
  ...
  assert.match(workbench, /\/erp\/index\.html\?v=20260730-review-logout-cache-03/);
  assert.match(dashboardService, /const LEGACY_UI_VERSION="20260730-review-logout-cache-03"/);
