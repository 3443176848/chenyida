...
export const TARGET_TABLES = Object.freeze({
  ...
  inventory_balance: "inventory_stock_balances", purchase_order: "purchase_orders", purchase_receipt: "purchase_receipts",
  ...
  finance_document: "finance_documents", finance_opening: "MODEL_GAP", file: "FILE_REFERENCE_PLAN", audit: "audit_log",
});

export const MAPPING_REGISTRY = Object.freeze({
  version: "selfhost-source-map-v1",
  ...
  inventory: { location_code: "MAIN", lot_code: "", balance_only: "OPENING_PLAN" },
  finance: { stable_sources: ["purchase_receipt", "shipment"], unsupported_opening: "MODEL_GAP" },
});
