...
export default function DispatchPage() {
  ...
  return <main className="sourcing-shell">
    <header className="sourcing-header"><div><Link href="/">← 经营工作台</Link><h1>生产派工准备（NORMAL 工序分批派工）</h1><p>本页只创建 NORMAL Run，仅展示按固化顺序到达的第一待执行工序；不提供开工、完工或报工按钮，也不接受 LEGACY_UNSTRUCTURED 来源。返工不从普通 WIP、库存或领料入口派发。</p><nav><Link href="/production/rework-requests">REWORK 显式派工</Link> · <Link href="/production/operations">NORMAL / REWORK 执行</Link> · <Link href="/production/wip">WIP 看板</Link></nav></div></header>
