...
const ROLE_PERMISSIONS: Record<IdentityRole, string[]> = {
  ...
  production: [...readOnly, ...masterRead, ...inventoryRead, ...procurementRead, ...productionRead, ...productionRoutingRead, ...productionRoutingSnapshotRead, ...productionHandoffProduction, ...salesRead, ...qualityRead, ...finishedGoodsAllocationRead, ...financeRead, "production.plan", "production.report", "production.report.reverse", "production.dispatch", "production.execute"],
