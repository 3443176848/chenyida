...
export function permissionsForRole(role: IdentityRole): string[] {
  ...
  return [...new Set([...ROLE_PERMISSIONS[role], ...operations, ...planning, ...requirements, ...sourcing])].sort();
}
