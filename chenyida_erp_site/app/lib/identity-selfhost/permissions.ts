...
const governanceReadPermissions = ["material.import.governance.read"];
const governanceRunPermissions = [...governanceReadPermissions, "material.import.governance.run"];
const governanceDecisionPermissions = [
  ...governanceRunPermissions,
...
const supplierMappingRead = ["supplier_mapping.read"];
const supplierMappingPurchase = [...supplierMappingRead, "supplier_mapping.create", "supplier_mapping.edit_draft", "supplier_mapping.submit"];
const supplierMappingReview = [...supplierMappingRead, "supplier_mapping.review_queue", "supplier_mapping.approve", "supplier_mapping.reject"];
const supplierMappingAll = [...supplierMappingPurchase, ...supplierMappingReview];
const masterRead = ["master.customer.read", "master.supplier.read", "master.product.read", "master.bom.read", "master.supplier_mapping.read", ...supplierMappingRead];
...
const ROLE_PERMISSIONS: Record<IdentityRole, string[]> = {
  ...
  warehouse: [...readOnly, ...masterRead, ...inventoryManage, ...procurementRead, ...procurementFulfillmentWarehouse, ...productionRead, ...productionHandoffRead, ...salesRead, ...salesDeliveryWarehouse, ...qualityRead, ...finishedGoodsAllocationRead, ...financeRead, "procurement.reverse", "production.issue", "production.complete", "production.complete.reverse", "sales.ship", "sales.reverse"],
  ...
  operations: [...readOnly, ...materialReviewPermissions, ...masterRead, ...supplierMappingReview, ...inventoryRead, ...procurementRead, ...productionRead, ...productionWorkCenterManage, ...salesRead, ...qualityRead, ...financeRead],
};
