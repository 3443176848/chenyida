...
export type RoutingDigestOperation = Readonly<{ sequence_no: number; operation_code: string; operation_name: string; work_center_id: number; work_center_code: string; work_center_name: string; setup_minutes: string; run_minutes_per_unit: string; description: string }>;
