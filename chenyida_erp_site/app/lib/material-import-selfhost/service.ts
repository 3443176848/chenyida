...
export function sourceColumnCount(raw: unknown): number {
...
export async function insertItems(client: Queryable, mappingId: number, items: readonly MappingItemInput[]): Promise<void> {
