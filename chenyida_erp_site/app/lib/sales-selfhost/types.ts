...
export type ShipmentLineInput = Readonly<{ salesOrderLineId: number; inventoryLotId: number | null; quantity: string; expectedLineVersion: number; expectedBalanceVersion: number; expectedLotVersion: number | null }>;
export type DeliveryInstructionLineInput = Readonly<{ salesOrderLineId: number; quantity: string; expectedLineVersion: number }>;
export type DeliveryExecutionLineInput = Readonly<{ instructionLineId: number; inventoryLotId: number | null; quantity: string; expectedLineVersion: number; expectedSalesOrderLineVersion: number; expectedBalanceVersion: number; expectedLotVersion: number | null }>;
