...
export class ProcurementRepository {
  ...
  async execute(meta: ProcurementMeta, work: ProcurementWork): Promise<ProcurementResult> {
    ...
    try {
      ...
      await client.query("select set_config('cyd.procurement_service_write','allowed',true),set_config('cyd.inventory_service_write','allowed',true),set_config('cyd.procurement_fulfillment_service_write','allowed',true)");
