...
const ROLE_DOMAINS:Record<string,DashboardDomain[]>={
  ...
  purchase:["material","partners","inventory","procurement","quality"],engineering:["material","partners","engineering","inventory"],production:["material","engineering","inventory","procurement","production","quality"],warehouse:["material","inventory","procurement","production","sales","quality"],quality:["inventory","procurement","production","sales","quality"],sales:["partners","engineering","inventory","sales","quality"],finance:["partners","procurement","sales","finance"],
};
