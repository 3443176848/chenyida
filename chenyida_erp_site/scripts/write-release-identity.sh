...
[ "$RUNTIME_POLICY_SHA256" = 8c9f9fd06eb4533faeeed4c316eb93568c38b3a42ac8c48dd081fbb4e7a2f444 ] || { echo "postdeploy runtime policy authorization is invalid" >&2; exit 1; }
