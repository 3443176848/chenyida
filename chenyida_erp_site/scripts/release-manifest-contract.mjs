...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "079677e32c732af65fec77639e61f12040704f3367aeda0854426b0259743597";
export const RELEASE_TEST_INVENTORY_SHA256 = "c3e599b5c83c88ee03afa58869a578336d2429e776008e932654a89762c0b1a5";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 239 || value.test_inventory.required_tests !== 215 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 83, POSTGRES_ALIAS: 2, PURE_NODE: 115, RELEASE_CONTRACT: 6, SPECIAL_HARNESS: 5 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
