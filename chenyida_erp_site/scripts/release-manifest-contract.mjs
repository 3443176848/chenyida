...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "0b5c41c980443611000fb98697c202347d042d3421a8dd9e814fd6049ff20426";
export const RELEASE_TEST_INVENTORY_SHA256 = "68554bfb4b1d8845be4b76d073785bd03da9e113ef3757323a8633ddd9f6a53d";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 242 || value.test_inventory.required_tests !== 218 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 83, POSTGRES_ALIAS: 2, PURE_NODE: 116, RELEASE_CONTRACT: 6, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
