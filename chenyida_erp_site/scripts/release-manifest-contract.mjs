...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "778261d00406c7e65ade30b8326892fdb9d1acbb967b29ad2f1a93cf5dbaed31";
export const RELEASE_TEST_INVENTORY_SHA256 = "d59cc81029c8e8861f44ebbac186fdf83ac0a184c1357bc821ce48f80af5931c";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 249 || value.test_inventory.required_tests !== 225 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 84, POSTGRES_ALIAS: 2, PURE_NODE: 122, RELEASE_CONTRACT: 6, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
