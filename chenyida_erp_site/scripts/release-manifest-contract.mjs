...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "e4c4452c009f0fc07de956aa732de4674e5e35ff2f5667f3e0b27e305917435a";
export const RELEASE_TEST_INVENTORY_SHA256 = "cad3d2b37666aa3e68e02fb770042216577909305a836f1d5c01355b3c630ecd";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 259 || value.test_inventory.required_tests !== 235 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 84, POSTGRES_ALIAS: 2, PURE_NODE: 130, RELEASE_CONTRACT: 8, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
