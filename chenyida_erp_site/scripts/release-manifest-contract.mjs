...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "3675b11a7585bba28b05653876e27cfb24035016842ebdba4c48e03466bc6b8d";
export const RELEASE_TEST_INVENTORY_SHA256 = "6b43ec62e76e91feab87c59ac1e2d95bcbb4e607508f1d00c0dc4bb9c8f0ff53";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 254 || value.test_inventory.required_tests !== 230 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 84, POSTGRES_ALIAS: 2, PURE_NODE: 127, RELEASE_CONTRACT: 6, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
