...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "cecb2293f758421f632f153a24aaf02e794b6e813d07d5b2ba0da9024abb5245";
export const RELEASE_TEST_INVENTORY_SHA256 = "64bb79d70d960ffcb8a63db03cc6c816042a4bc4b69934c49dc647b99fe0a2be";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 251 || value.test_inventory.required_tests !== 227 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 84, POSTGRES_ALIAS: 2, PURE_NODE: 124, RELEASE_CONTRACT: 6, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
