...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "02f888a4812488dc12ea00a41f3d1a21749238f0925dd7b9597452dfe316db6f";
export const RELEASE_TEST_INVENTORY_SHA256 = "8b00a6cdfec0f91870bcc2aab9f24c1331a860b1999859bc4b3ab6fa7f8d4f47";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 262 || value.test_inventory.required_tests !== 238 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 84, POSTGRES_ALIAS: 2, PURE_NODE: 130, RELEASE_CONTRACT: 11, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
