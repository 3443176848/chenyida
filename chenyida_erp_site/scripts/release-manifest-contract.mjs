...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "9dfc7f9fc068e8967a3ac394c847e4cb22207aacfbe551ab9588b6533ca21c40";
export const RELEASE_TEST_INVENTORY_SHA256 = "a378c049d1a5874fc2ec179e642ebdb2ef7b70f906e7634d95945c2bcf0cf993";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.postgres_runtime_catalog.path !== "operations/postgresql-runtime-privilege-compiled-catalog-v1.json"
    || value.postgres_runtime_catalog.file_sha256 !== "8eedab4e2d6f074b08396cb629d47c5f3400fd2f97e00c9a00469165276e14e8"
    || value.postgres_runtime_catalog.artifact_sha256 !== "9e331334c1636b2ee46180df3aca6850c7831470782f7f03856a6efef962480b"
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 263 || value.test_inventory.required_tests !== 239 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 84, POSTGRES_ALIAS: 2, PURE_NODE: 131, RELEASE_CONTRACT: 11, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
