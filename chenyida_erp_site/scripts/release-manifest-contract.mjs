...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "28df2e705eba8f4a77ae3f2736366ab32613acfc46662acf090d73efa78dba0f";
export const RELEASE_TEST_INVENTORY_SHA256 = "f8c9727adc50cd7173b3ac635d6279c1463a1b55856a86baffaa4b0a793c4f98";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 241 || value.test_inventory.required_tests !== 217 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 83, POSTGRES_ALIAS: 2, PURE_NODE: 115, RELEASE_CONTRACT: 6, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
