...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "8566cdd2fe0b49ceabafb239bc3aec97cbdfaca8ffaa15309cb2f66a628f124e";
export const RELEASE_TEST_INVENTORY_SHA256 = "502e36cb0b2eba814d3b690f1c64b88bc44b63cea2b9146689898395b172f35a";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 261 || value.test_inventory.required_tests !== 237 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 84, POSTGRES_ALIAS: 2, PURE_NODE: 130, RELEASE_CONTRACT: 10, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
