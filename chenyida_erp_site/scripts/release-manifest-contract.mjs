...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "e19331bb931a8ee3a40dc3215a951112a9bef51c90ac24f58ffa6c81f3c99e68";
export const RELEASE_TEST_INVENTORY_SHA256 = "33115a64a3937fc70eb20abeab666ca5be81477bf719f9e61e4844b52d52a81b";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 252 || value.test_inventory.required_tests !== 228 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 84, POSTGRES_ALIAS: 2, PURE_NODE: 125, RELEASE_CONTRACT: 6, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
