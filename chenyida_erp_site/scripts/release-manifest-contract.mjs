...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "a6e6452d6e0abe2a9ac0598eb635164a732c016dc90569e8b02515d18f7692ee";
export const RELEASE_TEST_INVENTORY_SHA256 = "d361db4edc65a901a9f73a6a16d9af5bf2806e4f7f8e92c5c27cef21487f9113";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 239 || value.test_inventory.required_tests !== 215 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 83, POSTGRES_ALIAS: 2, PURE_NODE: 113, RELEASE_CONTRACT: 6, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
