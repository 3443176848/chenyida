...
export const RELEASE_TEST_RUNTIME_POLICY_SHA256 = "c15fb38b7f2ed75abc4332cdcf8f1e3510ad5720f56049511fad892977e780d8";
export const RELEASE_TEST_INVENTORY_SHA256 = "6f82501e932904cf838db9d1faf1ff6ddf4d42e6f7a1ced14c6c974a1d5e1d18";
...
export function validateOfficialTestRuntimePolicy(value, raw = null) {
  ...
  if (value.test_inventory.path !== "chenyida_erp_site/release/release-test-inventory-v1.json" || value.test_inventory.sha256 !== RELEASE_TEST_INVENTORY_SHA256 || value.test_inventory.total_tests !== 250 || value.test_inventory.required_tests !== 226 || value.test_inventory.not_applicable_tests !== 24 || canonicalJson(value.test_inventory.category_counts) !== canonicalJson({ BROWSER: 6, HISTORICAL_D1_SITES: 22, POSTGRES: 84, POSTGRES_ALIAS: 2, PURE_NODE: 123, RELEASE_CONTRACT: 6, SPECIAL_HARNESS: 7 })) reject("TEST_RUNTIME_INVENTORY_INVALID");
