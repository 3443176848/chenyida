...
| 当前 Branch | 根仓库 `main` |
| 当前根仓库功能基线提交 | `PHASE3-MATERIAL-LIBRARY-CONFIDENCE-SORT-01`，实际提交以 `git log -1` 为准 |
...
| 当前阶段 | 电容匹配基线和清洗审核匹配置信度排序已部署；V700 已重新导入 229 条 |
| 当前任务 | `PHASE3-MATERIAL-LIBRARY-CONFIDENCE-SORT-01` 已完成；支持最新、置信度降序和升序 |
| 下一任务 | 项目负责人切换置信度升降序，并核对 V700 的五条电容候选编码 |
