...
32. 完整 ERP 业务尚未迁移到 Node/PostgreSQL 自托管 API；Customer/Supplier/Product/BOM/Supplier Mapping 已完成非生产关系化迁移，但采购、库存、生产、销售、品质和财务仍依赖当前 Python/SQLite 开发运行面，不能仅因 PostgreSQL 已有表结构就声称业务已切换。
