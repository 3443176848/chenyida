...
- 影响：本决策只确认书面布局方向，不授权前端实施、API/schema/migration 修改或生产部署。完整交互、错误、URL 状态、组件和测试规格见 `docs/material-master/material-read-ui-v1.md`；实施仍须等待“规格确认”并另建任务。
