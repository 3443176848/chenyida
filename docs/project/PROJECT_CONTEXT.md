...
- 当前采购接收只读基线：Package ID 2/v2 `ACCEPTED`、Material Requirement Plan ID 1/v1 `SUBMITTED`、PRQ ID 1 / `PRQ-00000001` `SUBMITTED`；Purchase ACCEPT/RETURN `0/0`、待接收/已处理 `1/0`。Material 533—536 各为毛需求/净采购/PRQ `10/10/10 PCS`、四项快照供应 0，九项当前供应也全部 0；Inventory Balance/Planning Allocation 与 RFQ/Quote/Award/PO/Delivery Plan/Receipt/Ledger/AP/Work Order 为 0。FIX-17 正式保护指纹在部署前、第二空库、主 UAT 前后均为 `e80ed1795079a3467ba4f05e2751fd8a9575e1b441b2433b371651479ca2cab0`。主 UAT 唯一一次打开确认窗后 runner 定位二义安全中止，没有重跑或业务决策，故功能已部署但主 UAT 未完整核验。
