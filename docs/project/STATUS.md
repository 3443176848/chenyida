...
| 当前测试绑定 | PARTIAL / NEW INVENTORY BOUND / FINAL FULL REGRESSION RUNNING | inventory为`248/224/24`、SHA-256`5d7e4be5…81a9b`，test runtime policy为`2324f8ac…93e65`，catalog文件/artifact为`87596b31…fb4cf`/`694daeb7…30b`；operator16/16、Supervisor定向29/29、release/catalog34/34、postdeploy probe3/3和真实PG17 system adapter已通过。干净Node前两次分别发现测试摘要漏绑及旧wrapper锁路径断言，均按集中锁合同修正且未降低安全语义；重新绑定后从头复跑 |
