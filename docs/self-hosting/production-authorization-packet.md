...
> 当前事实刷新：`SELFHOST-UAT-COMPOSE-DEPLOY-75` / D-150
...
| 当前快照输入 | `86be6d4b139e6626067a6a1782a3636d076f058a` / tree `006c230976d8dd985394b59a7b0965f90b2e1a51` | alpha.47 / Migration 46/head；表示D-135—D-150及promotion transaction BEGIN/RECOVER/CAPTURE/QUIESCE/AUTHORIZE/MIGRATION COMMIT/COMPOSE DEPLOY仓库输入，不表示存在源码匹配Web/Worker镜像、真实checkpoint 8/9回执、postdeploy回执或已安装host |
...
| supervisor source | `c6c4864dc99afb9c2bbb2c4b164e1f1e2beff5ee` / tree `2627d383699005e58c58b4dae6c8880e11fa84e7` | 包含当前monitor manifest、D-135—D-150、promotion transaction policy/journal、数据库围栏、逐文件Migration与精确Compose部署回执、批准/授权/UAT审计release门及132个固定文件的权威Supervisor来源提交 |
| supervisor manifest | `86be6d4b139e6626067a6a1782a3636d076f058a` / tree `006c230976d8dd985394b59a7b0965f90b2e1a51` | supervisor source的直接单文件子提交，只更新canonical Supervisor bundle manifest |
| supervisor bundle | `249d28feec8b9f26a3ccb373f7a6a9790f407467243a55cc48e69246a9753071` | 132文件，生成器逐字节重放一致；本值是manifest文件SHA-256 |
...
| installer | `51f0f4eb52fe7a8139ddf14bb1d473ea2a758a8db824a6eb0bada14cbb9306a0` | 只接受固定安装动作和短时root-only授权；固定上限已与132文件bundle一致，未解决的recovery或egress activation链会阻断bundle切换 |
| launcher | `8b74e37c6977923320cccc3e22839a13c50b59233132284a420386b4f7abbb86` | 先取得全局锁、验证候选快照/runtime/monitor/recovery/egress/promotion输入，再消费授权；v6 BEGIN/CAPTURE/QUIESCE/AUTHORIZE/MIGRATION EXECUTION/COMPOSE DEPLOY均先写intent，RECOVER精确绑定原已消费授权；checkpoint 8主动围栏只由checkpoint 9精确result+transfer接管 |
