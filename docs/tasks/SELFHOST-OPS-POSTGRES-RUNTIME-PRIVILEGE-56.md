...
- operator policy文件/逻辑SHA-256为`53b502fd1da16de49fee333709b408504313bd2bffe902a99df7e83d6211d163`/`85c7d2ea7b075d9ffd20a8a1962648fdaeba63509b2a7af59cb671e4c9f17acc`；runtime privilege policy文件/逻辑为`9870daab872a0e4df4958bce98f26ffef2ed2bdfc94047974e64a0cd49d3ef3c`/`e31413ae3b8fe8ef4c119e043db8d7777524ac5ad4515936727aab57dbd66ddf`；PG17 catalog文件/artifact为`e5f3c321e78a938ae8c1fb2dec3cba6d0ea7202d9c71fcddc9ea5b87fa1c71e3`/`b8536bc18531a819e8baa77012f9ef91e67241cc769978df482b81aa6a869beb`。正式inventory为`248/224/24`、SHA-256`1112404dbdd9a1c9d37f7e4c2e2f55799385247ec7d1c84b85fe30bd0c445ab5`，test runtime policy为`df82237bc78abfde5b8b67e4881dab5f73c76678f7fffbf668daeddb748f36e7`。
- 干净Node已通过121文件/1025项；正式PG包装器的84文件/401项也全部通过，但后续catalog门在`RUNTIME_PRIVILEGE_RECONCILE`失败关闭。独立阶段重放显示新operator事务把五个`\password`和响应放在同一stdin buffer，旧catalog脚本却仍用`psql -f`，因而等待外部交互口令。BOOTSTRAP与结构no-op RECONCILE两处已统一改为stdin并新增静态禁止`-f`断言；固定PG17隔离refresh与完整catalog test均退出0，内容寻址制品及下游策略已重绑。最终PG包装器及其余完整适用回归将从本修复提交重新执行。
