...
- operator policy文件/逻辑SHA-256为`e92f6d217dd9481a266258850698bc154ba0966613d8b33e7e426fd3730cdf74`/`b2e5cc0ff9a6febc8427a84286ef76f56bb3bd6de81f579ecc9ee7e00a1c7f65`；PG17 catalog文件/artifact为`87596b3183f274ff9834c04e483da5b3c07ac3c1dfc7d4b9d6123037d49fb4cf`/`694daeb7d309cc1f0eb923158769daf936fd01cf4deac1cfde176af03f26c30b`。正式inventory为`248/224/24`、SHA-256`5d7e4be549c062e1063916e071d84f4aeade01daae1655785ca1c6fff6481a9b`，test runtime policy为`2324f8ac9be99a0d2fe0a4bd53a1ce14af8634cc44bfcca95aafa56b64c93e65`；首次干净Node全套发现release gate测试摘要漏绑，修正后第二次又发现postdeploy probe测试仍要求每个wrapper复制锁路径。现已把原断言更新为唯一helper/mjs固定路径、shell wrapper必须source helper且不得复制路径，专项3/3通过；重新绑定后从头重跑。
