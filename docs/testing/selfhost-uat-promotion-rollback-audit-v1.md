...
- artifact SHA-256：`cc12d6135cb8b45816aa9e36123f396a34512d330df637ab02b6f0d6fac56187`
- source manifest SHA-256：`74893a7616343434f71fcecd94cf0d97a8f4d3a96aa568c1d97225c8bfc39605`（28文件）
- release inventory SHA-256：`d5be6d6d082812ac0077ca0b1f5563ee372cdd133aa2f98e0b2bb303da8b8af4`（260项）
...
当前识别32个Supervisor操作；所需13个UAT晋升/回退操作中实现13个、缺失0个。
...
- 回退运行时：`MISSING_BUNDLED_RUNTIME_ADAPTER_FAIL_CLOSED`；生产适配器缺失会在授权消耗前预检失败，当前没有真实数据库、四数据域、Web/Worker切换权限。
...
| `chenyida_erp_site/operations/cross-role-uat-evidence-contract-v1.json` | `66e3996cdc6d41f48288089eb47dd44e713ccc11688dd111be20a16eea4d7a2e` |
...
| `chenyida_erp_site/scripts/install-release-supervisor.py` | `fc15cc4fdd0671c643cdf95174cc268e009a6263fa9af4b1f48a4f237f887e19` |
...
| `chenyida_erp_site/scripts/release-manifest-contract.mjs` | `52994e70af023cce7b38d777f42f8d11b0fb99fa6f3fbce7726d667b9846c6bc` |
...
| `chenyida_erp_site/scripts/release-supervisor-launcher.py` | `37cd44a975bfcb0ad09e8c3d69637dd1d429dcca0d43b73c15afaa63dfc474fe` |
...
| `chenyida_erp_site/scripts/uat-promotion-rollback-contract.mjs` | `0c42f9d36cc56eb921e1141948d895203e381d3fc37b5aaa947106de365c8705` |
| `chenyida_erp_site/scripts/uat-promotion-rollback-control.mjs` | `882db264dc73a48a4bc94074f3f5e6cf3c64da19eae051fe4eea95ea5cd90110` |
| `chenyida_erp_site/scripts/uat-promotion-transaction-journal.mjs` | `c9b2e2b152fa856f31470cb5611b3b7fa55764225011d566748eb44cc2378494` |
