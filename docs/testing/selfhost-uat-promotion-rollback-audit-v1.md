...
- artifact SHA-256：`ee87cbf9512017062d563e1712817df7091d0b3183e7f4ea4d87b3c56c75cc94`
- source manifest SHA-256：`cca6644c56592e34fc43a231e3c47c44c080f342edf2c4b7ad803a25610f9843`（30文件）
- release inventory SHA-256：`502e36cb0b2eba814d3b690f1c64b88bc44b63cea2b9146689898395b172f35a`（261项）
...
- 回退运行时：`BUNDLED_TRUSTED_GATEWAY_EXECUTOR_NOT_IMPLEMENTED_OR_ACTIVATED_FAIL_CLOSED`；受信网关会核对固定activation、plan、工具身份、process-group与响应，但固定执行器或激活缺失仍会在授权消耗前失败，当前没有真实数据库、四数据域、Web/Worker切换权限。
...
| `chenyida_erp_site/operations/cross-role-uat-evidence-contract-v1.json` | `d26372abb586da46e4d7fb8affa36e737d49cd92e33d85ffe310139ff09e780b` |
...
| `chenyida_erp_site/scripts/install-release-supervisor.py` | `2d1bbea3a99e17dc8cb416b2305e441174e8c8616b284c1247e0af1f3b0ddca4` |
...
| `chenyida_erp_site/scripts/release-manifest-contract.mjs` | `7899672d4b0e07e44f6f6d1a713a4f00ed88d7f5e65d9e4d2e676cec050fde15` |
...
| `chenyida_erp_site/scripts/release-supervisor-launcher.py` | `15e75b55dae989628d7ec829ff665e51811e6f28b2d9a5108d209fde681c2585` |
...
| `chenyida_erp_site/scripts/uat-promotion-rollback-runtime-adapter.py` | `6ff55a12e8cb1ac00e9df97e613d446243123ca8498d5e6a75f22805c7ad4edb` |
| `chenyida_erp_site/scripts/uat-promotion-rollback-runtime-contract.mjs` | `029218aac986e968cbb8aaad3ed69ab526bf0ada91bb3a303bc672d37e2df2e0` |
